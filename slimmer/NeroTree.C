...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../Sample/TTJets/nero_0006.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../Sample/TTJets/nero_0006.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("../../Sample/TTJets/nero_0006.root:/nero");
...
void NeroTree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("fatjetak8Monojetid", &fatjetak8Monojetid, &b_fatjetak8Monojetid);
   ...
   fChain->SetBranchAddress("fatjetca15Monojetid", &fatjetca15Monojetid, &b_fatjetca15Monojetid);
