...
plotter.MakeCanvas('~/www/plots/160707/compare_releases_pT',30,250,1000,"p_{T} [GeV]","A.U.")
plotter.SetDefaultExpr('fatjet1PrunedM')
plotter.MakeCanvas('~/www/plots/160707/compare_releases_masspruned',20,0,200,"m_{pruned} [GeV]","A.U.")
plotter.SetDefaultExpr('fatjet1Mass')
plotter.MakeCanvas('~/www/plots/160707/compare_releases_mass',25,0,250,"m_{raw} [GeV]","A.U.")
plotter.SetDefaultExpr('met')
plotter.MakeCanvas('~/www/plots/160707/compare_releases_met',30,250,1000,"E_{T}^{miss} [GeV]","A.U.")
plotter.SetLegendLocation(plotter.kUpper,plotter.kLeft,0.4,0.3)
plotter.SetDefaultExpr('fatjet1tau21')
plotter.MakeCanvas('~/www/plots/160707/compare_releases_tau21',24,-0.2,1.0,"#tau_{2}/#tau_{1}","A.U.")
